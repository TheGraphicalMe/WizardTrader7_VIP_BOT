...
def trigger_sheet_sync(broker: str, account_id: str, email: str = "", extra_data: dict = None,
    ...
    if GOOGLE_SHEETS_WEBHOOK_URL:
        try:
            ...
            loop.create_task(append_to_sheet(broker, account_id, email, extra_data, client_uid, mt5_id))
        except RuntimeError:
            ...
            asyncio.run(append_to_sheet(broker, account_id, email, extra_data, client_uid, mt5_id))
